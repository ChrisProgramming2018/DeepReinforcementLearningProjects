""" First improvement to DQN the Double DQN use different Networks for the Q-Function and choseing the action """
import os
import random
import numpy as np
import torch
...
class Double_DQNAgent(object):
    ...
    def __init__(self, args, state_size, action_size):
        ...
        if torch.cuda.is_available():
            self.qnetwork_local = QNetwork(state_size, action_size, args.hidden_size_1, args.hidden_size_2, args.seed)
            self.qnetwork_target = QNetwork(state_size, action_size, args.hidden_size_1, args.hidden_size_2, args.seed)
