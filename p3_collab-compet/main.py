...
if __name__ == "__main__":
    ...
    parser.add_argument('--tau', type=float, default=1e-3, metavar='γ', help='Discount factor')
    parser.add_argument('--actor-learning-rate', type=float, default=1e-4, metavar='η', help='Learning rate')
    parser.add_argument('--critic-learning-rate', type=float, default=3e-4, metavar='η', help='Learning rate')
