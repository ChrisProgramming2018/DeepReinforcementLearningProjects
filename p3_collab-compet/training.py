...
def main(args):
    ...
    """
    args.actor_hidden_units = (args.hidden_units_1, args.hidden_units_2)
    args.critic_hidden_units = (args.hidden_units_1, args.hidden_units_2)
...
if __name__ == "__main__":
    ...
    parser.add_argument('--hidden_units_1', type=int, default=512, metavar='SIZE', help='Network hidden size')
    parser.add_argument('--hidden_units_2', type=int, default=256, metavar='SIZE', help='Network hidden size')
