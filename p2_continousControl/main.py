...
if __name__ == "__main__":
    ...
    parser.add_argument('--env-name', default="SawyerLift", type=str, help='Name')
    ...
    parser.add_argument('--max_timesteps', default=1e6, type=int)               # Total number of iterations/timesteps
    ...
    parser.add_argument('--max_episode_steps', default=1000, type=int)    # amount of qtarget nets
